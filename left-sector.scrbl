...
@(define bystro-conf   
   (bystro (bystro-connect-to-server (build-path (find-system-path 'home-dir) ".config" "amkhlv" "latex2svg.xml"))
           "left-sector/formulas.sqlite"  ; name for the database
           "left-sector" ; directory where to store image files of formulas
           25  ; formula size
...
@section{Geometry of Lorentzian worldsheet}
...
@section{Deforming the Lorentzian metric}
...
@section[#:tag "sec:left-deforming-vector-fields"]{Left-deforming vector fields}
...
@section[#:tag "sec:left-vector-fields"]{Left vector fields}
...
@section{The case of conformal vector fields}
...
@section{The case of left vector fields}
...
@section{The case of left-deforming vector fields}
