...
@page["Summary" #:tag "Summary" #:showtitle #t]
...
@page[@elem{Definition and main property of @f{\Omega}} #:tag "Definition" #:showtitle #t]
...
@page[@elem{Case when @f{E} is exponent}  #:tag "When E is exponent" #:showtitle #t]
...
@page["Algebraic Interpretation" #:tag "As Intertwiner" #:showtitle #t]
...
@page["Descent to the moduli space of Lagrangian submanifolds" #:tag "Descent To LAGs" #:showtitle #t]
...
@page["Descent to double coset" #:tag "Descent To Double Coset" #:showtitle #t]
...
@subpage[1 @elem{Straightforward descent does not work} #:tag "sec-Straightforward-descent-does-not-work"]
...
@subpage[1 @elem{Modified PDF} #:tag "sec-Modified-PDF"]
...
@page["Equivariant half-densities" #:tag "Equivariant half-densities" #:showtitle #t]

@bystro-local-toc[]

@subpage[1 @elem{Definitions} #:tag "sec-Definitions-2"]
...
@page[@elem{Subspace @f{{\cal F}\subset \mbox{Fun}(M)}} #:tag "Subalgebra F" #:showtitle #t]
...
@page["Construction of equivariant form" #:tag "Equivariant Form" #:showtitle #t]

@short-intro{@centered{We will now describe an @f{\bf h}-equivariant analogue of @f{\Omega}}}

@bystro-local-toc[]
@subpage[1 @elem{Construction of @f{\Gamma(\Phi)}} #:tag "sec-Construction-of-f-Gamma-Phi"]
...
@subpage[1 @elem{The equivariant version of @f{\Omega}} #:tag "sec-The-equivariant-version-of-f-Omega"]
@align[r.l.n @list[
...
@subpage[1 @elem{Possible anomaly} #:tag "sec-Possible-anomaly"]
...
@page["Example: Duistermaat-Heckman integration" #:tag "Duistermaat-Heckman formula" #:showtitle #t]
...
Let @f{\pi} denote the Poisson bivector of @f{X}. It defines the following solution of the Quantum Master Equation:
@align[l.n @list[
...
BV-canonical transformation of @f{\Pi T^* X} generated by the BV-Hamiltonian @f{\Delta_{\rho_{1\over 2}} (p^*F)}.

Every point @f{x\in X} defines a Lagrangian submanifold in @f{\Pi T^* X}: the fiber @f{\Pi T^*_x X}. Therefore,
we can think of @f{X} as a family of Lagrangian submanifolds in @f{\Pi T^* X}. 

In this case @f{\cal F} is the @f{p^*} of the subspace of Hamiltonians generating @f{H}. 
The equivariant form @f{\Omega} becomes:
@align[r.l.n @list[
 @f{\phantom{\int_{\Pi T^*_xX}}\Omega(x,\!@bxd{dx},F) \;=\;} 
 @f{\int_{\Pi T^*_xX} \rho_{1\over 2} \exp\left(@bxd{dx}^i x^{\star}_i + F(x)\right)\;=}
 ""
]@list[
 @f{\;=\;}
 @f{\exp\left(\varpi_{ij}(x)@bxd{dx}^i @bxd{dx}^j + F(x)\right)}
 ""
]
]
where @f{\varpi = \pi^{-1}}.
...
@page["Example: interpretation of Cartan complex" #:tag "Interpretation of Cartan complex" #:showtitle #t]
...
@align[l.n @list[
 @elem[#:style 'no-break]{let @f{\rho^{(0)}_{1\over 2}\;=} the half-density on @f{M} induced from the volume form on @f{\Pi TX}}
 ""
]
]
...
field @f{d} on @f{\Pi TX}.
@comment{
We can replace @f{e^{\widehat{d}}} with an arbitrary function of @f{\widehat{d}}. This will still satisfy the Quantum Master Equation.
}
...
@align[r.l.n @list[
 @f{a(\xi) = } @f{\Phi\langle\xi\rangle = \widehat{\iota_{\xi}}} ""
]@list[
 @f{\rho^{\tt C}_{1\over 2}(\xi) =} @f{e^{\widehat{d} + \widehat{\iota_{\xi}}} \rho^{(0)}_{1\over 2}} ""
]
]
...
@align[r.l.n @list[
 ...
 @f{\widehat{{\cal L}_{\xi}}\alpha(\xi) e^{\widehat{d} + \widehat{\iota_{\xi}}} \rho^{(0)}_{1\over 2}  \;+}
 ""
]@list[
 ""
 @f{+ ((d+\iota_{\xi})\alpha(\xi))\,e^{\widehat{d} + \widehat{\iota_{\xi}}} \rho^{(0)}_{1\over 2}}
 ""
]
]
@div[redbox]{
Therefore @f{\alpha\;\mapsto\;\alpha e^{\widehat{d} + \widehat{\iota}}} is an intertwiner from the
Cartan complex to the complex of equivariant half-densities on @f{\Pi T^*(\Pi TX)}.
}


@page["Construction of base form" #:tag "Base Form" #:showtitle #t]
...
@page[@elem{Algorithm for constructing @f{F}} #:tag "Algorithm For F" #:showtitle #t]
...
@page[@elem{Canonical choice of @f{\cal F} in standard BRST formalism} #:tag "Case Of Standard BRST" #:showtitle #t]
...
@subpage[1 @elem{Standard choice of @f{\cal F}} #:tag "sec-Standard-choice-of-f-cal-F"]
...
@subpage[2 @elem{General formula} #:tag "sec-General-formula"]
@align[r.l.n @list[
...
@subpage[2 @elem{Special case of bosonic string} #:tag "sec-Special-case-of-bosonic-string"]
@align[r.l.n @list[
...
@page["Expansion in antifields" #:tag "Expansion In Antifields" #:showtitle #t]
...
@subpage[1 @elem{Particular cases} #:tag "sec-Particular-cases"]
@subpage[2 @elem{Standard BRST, standard polarization, off-shell symmetry} #:tag "sec-Standard-BRST-standard-polarization-off-shell-symmetry"]
@e{
...
@subpage[2 @elem{Bosonic string, @f{h} being diffeomorphisms} #:tag "sec-Bosonic-string-f-h-being-diffeomorphisms"]
...
@subpage[2 @elem{RNS} #:tag "sec-RNS"]
@spn[attn]{TODO}, but conjectured to be of the same type as bosonic.

@subpage[2 @elem{Pure spinor string} #:tag "sec-Pure-spinor-string"]
@spn[attn]{TODO}:
@itemlist[
...
@page["Unsafe operations" #:tag "Unsafe operations" #:showtitle #t]
...
@page["Reduction to integration over single Lagrangian submanifold" #:tag "As integration over single L" #:showtitle #t]
...
@subpage[1 @elem{Local construction} #:tag "sec-Local-construction"]
...
@subpage[1 @elem{Global definition of  @f{L_{\Lambda}} } #:tag "sec-Global-definition-of-f-L-Lambda"]
...
@subpage[1 @elem{Proof that @f{L_Λ} is Lagrangian} #:tag "sec-Proof-that-f-L-is-Lagrangian"]
