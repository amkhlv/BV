...
@page[@elem{Completely equivariant @f{\Omega}?} #:tag "Completely Equivariant" #:showtitle #t]
...
@page["General properties of string worldsheet theory" #:tag "Worldsheet Axioms" #:showtitle #t]
...
@page["Ambiguity in equivariant form" #:tag "Choice Of Equivariant Form" #:showtitle #t]
